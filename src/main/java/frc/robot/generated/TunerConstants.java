...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(SmartDashboard.getNumber("Rotation P", 0.5)).withKI(0).withKD(SmartDashboard.getNumber("Rotation D", 100))
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.0915234375);
